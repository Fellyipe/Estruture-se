// --- DETECTAR PICKUP / DROP ---

//if (carrying == noone) {
//    // procura caixa perto (pick_radius)
//    var candidate = collision_circle(x, y, pick_radius, obj_box_carry, true, false);
//    if (candidate != noone) {
//        if (!_pickup_box(candidate)) {
//            // feedback: não pegou
...
//    }
//} else {
//    // tenta largar; se não conseguir, manter carregando
//    if (!_drop_box()) {
//        // feedback: não é possível largar aqui
//    } else {
//        // sucesso: som
//    }
//}
